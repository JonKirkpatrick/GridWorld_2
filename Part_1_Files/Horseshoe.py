...
class GridWorldEnv:
    def __init__(self):
        ...
        self.red_states = [(3,4), (3,6), (2,4), (2,6), (1,4), (1,6), (5, 4), (5, 6), (6, 5), (4, 4), (4, 6), (6, 4), (6, 6)]
        self.blue_state = (10, 0)
        self.black_states = [(0, 0), (5, 5)]  # (5,5) with reward of 25, (0,0) with reward of 0
    ...
    def step(self, action):
        ...
        if not (0 <= next_state[0] < self.grid_size and 0 <= next_state[1] < self.grid_size):
            ...
            self.done = True
            reward = 35 if next_state == (5, 5) else 0
        else:
            reward = -1
